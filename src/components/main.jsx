...
export default function Main() {
    ...
    return (<div className="flex flex-col mx-auto gap-6 mt-[6rem] md:mt-[12REM]">
        <div className="lg:max-w-[100%] mx-auto flex flex-col gap-y-6" >
            ...
            <h2 className="font-inter text-white text-center text-xl font-bold mx-auto max-w-[36REM] px-6 md:p-0 ">Simply pick your Major, set your budget, and we’ll recommend a tailored starter kit that actually makes sense. </h2>
        </div>
